...
export class DiaryController {
  ...
  @ApiParam({
    name: "classid",
    description: "The ID of the class by which to get the diary",
    example: "2",
    required: true,
  })
  @ApiParam({
  ...
  @ApiQuery({
    name: "week",
    description: "Week number for which you want to get the diary",
    example: "5",
    required: false,
  })
  @ApiQuery({
    name: "year",
    description: "Year for which you need to get a diary",
    example: "2023",
    required: false,
  })
  ...
  @ApiParam({
    name: "childrenid",
    description: "ID of the child whose diary signature is to be obtained",
    example: "5",
    required: true,
  })
  @ApiQuery({
    name: "week",
    description:
      "Number of the week for which you want to get the signature of the diary",
    example: "7",
    required: true,
  })
  @ApiQuery({
    name: "year",
    description: "Year for which you need to get the signature of the diary",
    example: "2023",
    required: true,
  })
